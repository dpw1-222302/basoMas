...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#loginModal" data-toggle="modal">Masuk</a>
                </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="loginModalLabel">MASUK</h5>
                ...
                <form action="index.php" method="POST">
                    <div class="modal-body">
                        <form action="proses_login.php" method="POST">
                            ...
                            <div class="modal-body mb-3">Belum punya akun? <a class="regist" href="#registModal"
                                    data-dismiss="modal" data-toggle="modal">Daftar</a></div>
                        </form>
    ...
    <div class="modal" id="registModal" tabindex="-1" aria-labelledby="registModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="registModalLabel">DAFTAR</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="index.php" method="POST">
                    <div class="modal-body">
                        <form action="proses_register.php" method="POST">
                            ...
                            <div class="modal-body mb-3">Sudah punya akun? <a class="login" href="#loginModal"
                                    data-dismiss="modal" data-toggle="modal">Masuk</a></div>
                        </form>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
